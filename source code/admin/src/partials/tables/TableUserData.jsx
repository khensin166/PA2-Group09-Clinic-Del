...
import ModalCreate from '../modals/users-data/CreateModals';
import ModalEdit from '../modals/users-data/EditModals';
import ReadProductModal from '../modals/users-data/ReadModals';
import DeleteProductModel from '../modals/users-data/DeleteModals';
