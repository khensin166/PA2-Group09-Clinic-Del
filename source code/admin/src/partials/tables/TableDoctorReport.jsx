...
function Table() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('http://192.168.31.25:8080/doctor-report-approved', {
                    method: 'GET',
                    headers: {
                        'Authorization': `${token}`,
    ...
    const approveAppointment = async (id) => {
        try {
            const response = await fetch(`http://192.168.31.25:8080/doctor-report/${id}/approve`, {
                method: 'PUT',
                headers: {
                    'Authorization': `${token}`,
                    'Content-Type': 'application/json',
    ...
    return (
        <>
            ...
            < ReadProductModal
                ...
                apiMedicine="http://192.168.31.25:8080"
                token={token}
            />
